...
const stages = [
    { label: "Awareness", desc: "Reach the right audience", color: "#3b82f6", yTop: 40, wTop: 230, wBot: 180, h: 85 },
    { label: "Traffic", desc: "Draw them to your site", color: "#2563eb", yTop: 125, wTop: 178, wBot: 130, h: 85 },
    { label: "Leads", desc: "Convert visitors", color: "#1d4ed8", yTop: 210, wTop: 128, wBot: 82, h: 85 },
    { label: "Conversions", desc: "Clients & revenue", color: "#1e40af", yTop: 295, wTop: 80, wBot: 40, h: 85 },
];

const CX = 160;
const LABEL_X = 245;

export default function SEOFunnelBlue() {
    ...
    useEffect(() => {
        ...
        function drawBubbles() {
            bubbles.forEach((b) => {
                ...
                ctx.strokeStyle = `rgba(59,130,246,${b.alpha})`;
                ctx.lineWidth = 1;
                ctx.stroke();
        ...
        >
            ...
            >
                ...
                <div style={{ maxWidth: "270px" }}>
                    ...
                    >
                        From{" "}
                        <span style={{ color: "#3b82f6" }}>invisible</span>
                        <br />
                        to{" "}
