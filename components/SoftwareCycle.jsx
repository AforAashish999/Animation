...
function buildGearPath(cx, cy, outerR, innerR, toothW, numTeeth) {
  ...
  for (let i = 0; i < numTeeth; i++) {
    ...
    points.push([
      cx + outerR * Math.cos(a3),
      cy + outerR * Math.sin(a3),
    ]);
    points.push([
      cx + innerR * Math.cos(a4),
      cy + innerR * Math.sin(a4),
    ]);
  }
  return (
    "M " +
    ...
    >
      ...
      >
        ...
        <div style={{ maxWidth: "300px" }}>
          ...
          >
            From{" "}
            <span style={{ color: "#22c55e" }}>idea</span> to{" "}
        ...
        <div style={{ position: "relative", width: "520px", height: "480px" }}>
          ...
          >
            ...
            {/* Inner dark circle */}
            <circle cx={cx} cy={cy} r={105} fill="#0d1a12" />
            <circle
              cx={cx} cy={cy} r={105}
              fill="none"
              stroke="#166534"
