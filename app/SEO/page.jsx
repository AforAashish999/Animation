...
const stages = [
    { label: "Awareness", desc: "Reach the right audience", color: "#22d3ee", yTop: 40, wTop: 230, wBot: 180, h: 85 },
    { label: "Traffic", desc: "Draw them to your site", color: "#06b6d4", yTop: 125, wTop: 178, wBot: 130, h: 85 },
    { label: "Leads", desc: "Convert visitors", color: "#0891b2", yTop: 210, wTop: 128, wBot: 82, h: 85 },
    { label: "Conversions", desc: "Clients & revenue", color: "#0e7490", yTop: 295, wTop: 80, wBot: 40, h: 85 },
];

const CX = 160;
const LABEL_X = 245;

export default function SEOFunnelCyan() {
    ...
    useEffect(() => {
        ...
        function drawSwirl() {
            ...
            for (let i = 0; i < 3; i++) {
                ...
                ctx.strokeStyle = `rgba(6,182,212,${0.4 - i * 0.1})`;
                ctx.lineWidth = 1;
                ctx.stroke();
            }
        }
        ...
        function drawBubbles() {
            bubbles.forEach((b) => {
                ...
                ctx.strokeStyle = `rgba(6,182,212,${b.alpha})`;
                ctx.lineWidth = 1;
                ctx.stroke();
        ...
        <section style={{ background: "#111", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "40px 20px", fontFamily: "'Courier New', monospace" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "50px", maxWidth: "1000px", width: "100%", flexWrap: "wrap", justifyContent: "center" }}>
                <div style={{ maxWidth: "270px" }}>
                    <span style={{ display: "block", color: "#06b6d4", fontSize: "10px", letterSpacing: "3px", marginBottom: "12px" }}>SEO</span>
                    <h2 style={{ color: "#fff", fontSize: "30px", fontWeight: 800, lineHeight: 1.25, marginBottom: "14px", fontFamily: "'Courier New', monospace" }}>
                        From <span style={{ color: "#06b6d4" }}>invisible</span><br />
                        to <span style={{ color: "#06b6d4" }}>unstoppable</span>
                    </h2>
                    <p style={{ color: "#ffffff", fontSize: "13px", lineHeight: 1.8, marginBottom: "28px" }}>
                    ...
                    <button
                        style={{ background: "#06b6d4", color: "#000", border: "none", padding: "12px 24px", fontSize: "13px", fontWeight: 800, fontFamily: "'Courier New', monospace", letterSpacing: "1px", cursor: "pointer", borderRadius: "3px" }}
